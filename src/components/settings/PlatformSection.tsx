...
export function PlatformSection() {
  ...
  return (
    <section id="platform-team" className="space-y-6 scroll-mt-20">
      <div>
        <h2 className="text-2xl font-semibold">Platform</h2>
        <p className="text-sm text-muted-foreground mt-1">Platform-level configuration. Visible to platform admins.</p>
      </div>

      {isSuper && (
        <Card className="p-6">

          <h3 className="text-base font-semibold mb-1">Platform team</h3>
      ...
      {!isSuper && (
        <Card className="p-6">
          <h3 className="text-base font-semibold mb-1">Platform team</h3>
          <p className="text-sm text-muted-foreground">Only super admins can manage the platform team.</p>
        </Card>
      )}

      <IsbnWebhookSection />

      <div id="platform-branding" className="scroll-mt-20" />
      <Card className="p-6">
        <h3 className="text-base font-semibold mb-1">Platform branding</h3>
        <p className="text-sm text-muted-foreground">Coming soon — customize the LibrariOS marketing surfaces.</p>
      </Card>
